 ...
 */
package com.kosso.tiwebview2.impl;
...
import android.webkit.JavascriptInterface; // Kosso
...
public class TiUIWebView extends TiUIView
{
	...
	class JavascriptInterfaceObject {
		...
		public boolean postMessage(String jsonString, String transferList){
			...
			fireEvent("messageFromWebview", data); // Same event name as iOS version.
			return false;
		}
	}
	...
	public void setRequestHeaders(HashMap items) {
		...
		for (Map.Entry<String, String> item : map.entrySet()) {
			Log.d(TAG, "KOSSO: adding header " + item);
