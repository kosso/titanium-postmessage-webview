 ...
 */
package com.kosso.tiwebview2.proxy;
...
import com.kosso.tiwebview2.Tiwebview2Module;
import com.kosso.tiwebview2.impl.TiUIWebView;

@Kroll.proxy(creatableInModule=Tiwebview2Module.class, propertyAccessors = {
	TiC.PROPERTY_DATA,
